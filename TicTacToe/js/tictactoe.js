...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used to check each element of the array
...
//drawLine() function called to draw a line on the screen if condition is met
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        //end of y axis
        y2 = coordY2,
        //stores temp x axis data we update in our animation loop
        x = x1,
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        //method moves use to a starting point in our line
        c.moveTo(x1, y1);
        //method indicates the end point in our line
        c.lineTo(x,y);
        //method sets the width of our line
        c.lineWidth = 10;
        //method sets the color of our line
        c.strokeStyle = 'rgba(70,255,33,.8)';
        //method draws everthing we laid out above
        c.stroke();
    ...
    animateLineDrawing();
    //waits 1 second and then clears canvas, resets game, and allows clicking again
    setTimeout(function() { clear(); resetGame(); }, 1000);
}

//function resets game in the event of tie or win
function resetGame() {
    //iterates through each HTML square element
    for (let i = 0; i < 9; i++) {
        //variable gets the html in element i
